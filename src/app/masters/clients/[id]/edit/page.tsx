    ...
    <div className="edit-user-page contact-form-page">
      ...
      <section className="edit-user-card contact-form-card wide-card">
        <div className="edit-user-header">
          <h1><span style={{ display: "flex", alignItems: "center", gap: "10px" }}><Edit size={24} /> Edit Client</span></h1>
        </div>
        ...
        <form className="form-three-col" onSubmit={(e) => e.preventDefault()}>
          ...
          {/* Spacer to align Status in Column 3 */}
          <div className="edit-user-row compact" style={{ visibility: "hidden" }} />
